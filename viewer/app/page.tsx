...
export default function Home() {
  ...
  return <main className="min-h-screen bg-background text-foreground">
    ...
    <div className="mx-auto max-w-[1440px] px-5 py-7 lg:px-10 lg:py-10">
      ...
      <StationMap points={mapPoints} focusObjectKey={focusObjectKey} coordinateEdit={coordinateEdit} aerialReviewRequest={aerialReviewRequest} aerialResults={aerialResults} onSelect={setSelectedKey} onNavigateEndpoint={(objectKey, analysis, coordinateType) => { focusPlatform(objectKey); setAerialReviewRequest({ objectKey, analysis, coordinateType, nonce: Date.now() }); }} onBeginCoordinateEdit={setCoordinateEdit} onCoordinateChange={handleCoordinateChange} onCancelEdit={() => setCoordinateEdit(null)}/>
